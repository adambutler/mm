...
(function() {
  var GitHubApi, auth, blue, board, fakePoll, five, fs, getName, github, githubAuth, githubGenerateToken, githubPoll, handleResponse, init, initBoard, initGithub, lastTrackedEvent, log, prettyjson, prompt, queue, red, reset, servo, servoBusy, settings, setupPhotoresistor, setupServo, timeago, triggerServo, users;
